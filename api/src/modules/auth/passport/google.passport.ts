...
export default function googleStrategy () {
    passport.use(new GoogleStrategy({
            ...
            callbackURL: `${process.env.API_BASE_URL}/auth/google/oauth`, //? OAuth callback URL – Google redirects here after authentication
        },
                ...
                data: {
                  ...
                  profile: {
                    create: {
                      ...
                      username: username ?? '',
                      profilePicture: profile._json.picture ?? 'https://images.unsplash.com/vector-1742875355318-00d715aec3e8?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'
                    }
                  },
                  credentials: {
                    create: {
